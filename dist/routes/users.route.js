...
let UserRoute = class UserRoute {
    initializeRoutes() {
        ...
        this.router.post(`${this.path}`, (0, _validationmiddleware.ValidationMiddleware)(_usersdto.CreateUserDto, 'body'), this.user.createUser);
        this.router.put(`${this.path}/:id(\\d+)`, (0, _validationmiddleware.ValidationMiddleware)(_usersdto.CreateUserDto, 'body', true), this.user.updateUser);
