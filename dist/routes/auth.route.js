...
let AuthRoute = class AuthRoute {
    initializeRoutes() {
        this.router.post('/signup', (0, _validationmiddleware.ValidationMiddleware)(_usersdto.CreateUserDto, 'body'), this.auth.signUp);
        this.router.post('/login', (0, _validationmiddleware.ValidationMiddleware)(_usersdto.CreateUserDto, 'body'), this.auth.logIn);
